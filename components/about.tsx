...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
      I am a dynamic and ambitious individual currently navigating the world of web and Android development. I do <span className="font-medium">Computer Science studies</span>, I have delved into the practical aspects of my field, showcasing a passion for technology and programming. I enrolled in a coding bootcamp and learned{" "}
